...
| M6 Auth module | In progress | Scaffold landed in PR #82: email/password + JWT (access/refresh), TOTP MFA, WebAuthn/passkey, `AuthGuard`/`RolesGuard`/`PoliciesGuard`; unit tests pending (#30) |
